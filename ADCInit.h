 ...
 * Version: 2.1
 *
 * Description: This header file provides the function to initialize the on board
 *              12-BIT ADC. The ADC12 memories are mapped to the respective cell
 *              to analyze the analog voltage. The conversion cycles through the ADC12MCTL0 to
...
void init_ADC(void)
{
    ...
    P1SEL0 |= BIT3;                   //Analog input for the battery current
    P1SEL1 |= BIT3;
    ...
    // Set sampling time: 96 ADC12CLK's times, turn on ADC12, using the multiple sample and convert
    ...
    ADC12MCTL0 = ADC12INCH_7;   // (Batt sense) Data from CH7 P8.4  -> ADC12MEM0
    ADC12MCTL1 = ADC12INCH_4;       // (Cell 0) Data from CH4 P8.7  -> ADC12MEM1
    ADC12MCTL2 = ADC12INCH_5;       // (Cell 1) Data from CH5 P8.6  -> ADC12MEM2
    ADC12MCTL3 = ADC12INCH_9;       // (Cell 2) Data from CH9 P9.1  -> ADC12MEM3
    ADC12MCTL4 = ADC12INCH_10;      // (Cell 3) Data from CH10 P9.2 -> ADC12MEM4
    ADC12MCTL5 = ADC12INCH_11;      // (Cell 4) Data from CH11 P9.3 -> ADC12MEM5
    ADC12MCTL6 = ADC12INCH_13;      // (Cell 5) Data from CH13 P9.5 -> ADC12MEM6
    ADC12MCTL7 = ADC12INCH_3; // (Battery Current) Data from CH3 P1.3 -> ADC12MEM7
    ...
    ADC12MCTL9 = ADC12EOS;                   // End of ADC Sequencer
